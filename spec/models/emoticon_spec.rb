...
describe "Neo4j::Emoticon" do
  ...
  describe "initialization methods" do
    it "should generate a random unique uid 10 characters in length" do
      emoticon = Emoticon.new "the foorbar jumped over the moon"
